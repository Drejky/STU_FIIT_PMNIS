  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.dataControls}>
        ...
        <button className={styles.button} onClick={() => router.push('/map')}>
          Map
        </button>
        <button
      ...
      <div className={styles.graphContainer}>
        ...
        <div className={styles.graph}>
          ...
          <Image src="/images/mapa.png" layout="fill" objectFit="contain" />
        </div>{' '}
        <div className={styles.graph}>
          {/* <Bar data={data} options={options as any} /> */}
          <Image src="/images/grafikon.png" layout="fill" objectFit="contain" />
        </div>{' '}
      </div>
    </div>
  );
